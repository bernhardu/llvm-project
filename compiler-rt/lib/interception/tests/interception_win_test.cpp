...
const struct InstructionSizeData {
  ...
  const char *comment;
    ...
    { 3, {0x83, 0xE4, 0xF8}, 0, "83 E4 F8 : and esp, 0xFFFFFFF8"},
    { 3, {0x83, 0xEC, 0x64}, 0, "83 EC 64 : sub esp, 64h"},
    ...
    { 3, {0x83, 0xe4, 0xe0}, 0, "83 e4 e0 : and esp, 0xFFFFFFE0"},
    { 3, {0xf6, 0xc1, 0x07}, 0, "f6 c1 07 : test cl, 0x7"},
