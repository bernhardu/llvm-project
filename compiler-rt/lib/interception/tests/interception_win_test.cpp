...
const struct InstructionSizeData {
  ...
  const char *comment;
    ...
    {  3, { 0x8B, 0x4D, 0x72 }, 2, "8B 4D 72 : mov ecx,DWORD PTR [ebp+0x72]" },
    {  3, { 0x8B, 0x55, 0x72 }, 2, "8B 55 72 : mov edx,DWORD PTR [ebp+0x72]" },
    {  3, { 0x8B, 0x75, 0x72 }, 2, "8B 75 72 : mov esi,DWORD PTR [ebp+0x72]" },
    {  3, { 0xC2, 0x71, 0x72 }, 0, "C2 71 72 : ret 0x7271 (needed for registering weak functions)" },
    {  3, { 0xF6, 0xC1, 0x72 }, 0, "F6 C1 72 : test cl,0x72" },
    {  4, { 0x8D, 0x4C, 0x24, 0x73 }, 3, "8D 4C 24 73 : lea ecx,[esp+0x73]" },
    ...
    {  7, { 0x8D, 0xA4, 0x24, 0x73, 0x74, 0x75, 0x76 }, 3, "8D A4 24 73 74 75 76 : lea esp,[esp+0x76757473]" },
    ...
    {  4, { 0x44, 0x8d, 0x42, 0x74 }, 3, "44 8d 42 74 : lea r8d , [rdx + XX]" },
    {  4, { 0x48, 0x83, 0xec, 0x74 }, 0, "48 83 ec 74 : sub rsp, XX" },
    {  4, { 0x48, 0x89, 0x58, 0x74 }, 3, "48 89 58 74 : mov QWORD PTR[rax + XX], rbx" },
    {  4, { 0x49, 0x83, 0xf8, 0x74 }, 0, "49 83 f8 74 : cmp r8, XX" },
    {  4, { 0x49, 0x8d, 0x48, 0xff }, 3, "49 8d 48 ff : lea rcx,[r8-0x1]" },
    ...
    {  4, { 0x80, 0x78, 0x72, 0x73 }, 2, "80 78 72 73 : cmp BYTE PTR [rax+0x72],0x73" },
    {  4, { 0x80, 0x79, 0x72, 0x73 }, 2, "80 79 72 73 : cmp BYTE PTR [rcx+0x72],0x73" },
    {  4, { 0x80, 0x7A, 0x72, 0x73 }, 2, "80 7A 72 73 : cmp BYTE PTR [rdx+0x72],0x73" },
    {  4, { 0x80, 0x7B, 0x72, 0x73 }, 2, "80 7B 72 73 : cmp BYTE PTR [rbx+0x72],0x73" },
    {  4, { 0x80, 0x7D, 0x72, 0x73 }, 2, "80 7D 72 73 : cmp BYTE PTR [rbp+0x72],0x73" },
    {  4, { 0x80, 0x7E, 0x72, 0x73 }, 2, "80 7E 72 73 : cmp BYTE PTR [rsi+0x72],0x73" },
    {  4, { 0x89, 0x54, 0x24, 0x74 }, 3, "89 54 24 74 : mov DWORD PTR[rsp + XX], edx" },
    {  5, { 0x0F, 0x1F, 0x44, 0x00, 0x00 }, 4, "0F 1F 44 00 00 : nop DWORD PTR [rax+rax*1+0x0]" },
    {  5, { 0x44, 0x89, 0x44, 0x24, 0x75 }, 4, "44 89 44 24 XX : mov DWORD PTR [rsp + XX], r8d" },
    {  5, { 0x44, 0x89, 0x4c, 0x24, 0x75 }, 4, "44 89 4c 24 XX : mov DWORD PTR [rsp + XX], r9d" },
    {  5, { 0x48, 0x89, 0x4C, 0x24, 0x75 }, 4, "48 89 4C 24 XX : mov QWORD PTR [rsp + XX], rcx" },
    {  5, { 0x48, 0x89, 0x54, 0x24, 0x75 }, 4, "48 89 54 24 XX : mov QWORD PTR [rsp + XX], rdx" },
    {  5, { 0x48, 0x89, 0x5c, 0x24, 0x75 }, 4, "48 89 5c 24 XX : mov QWORD PTR [rsp + XX], rbx" },
    {  5, { 0x48, 0x89, 0x6c, 0x24, 0x75 }, 4, "48 89 6C 24 XX : mov QWORD PTR [rsp + XX], rbp" },
    {  5, { 0x48, 0x89, 0x74, 0x24, 0x75 }, 4, "48 89 74 24 XX : mov QWORD PTR [rsp + XX], rsi" },
    {  5, { 0x48, 0x89, 0x7c, 0x24, 0x75 }, 4, "48 89 7c 24 XX : mov QWORD PTR [rsp + XX], rdi" },
    {  5, { 0x48, 0x8b, 0x44, 0x24, 0x75 }, 4, "48 8b 44 24 XX : mov rax, QWORD ptr [rsp + XX]" },
    {  5, { 0x48, 0x8d, 0x6c, 0x24, 0x75 }, 4, "48 8d 6c 24 XX : lea rbp, [rsp + XX]" },
    {  5, { 0x4c, 0x89, 0x44, 0x24, 0x75 }, 4, "4c 89 44 24 XX : mov QWORD PTR [rsp + XX], r8" },
    {  5, { 0x4c, 0x89, 0x4c, 0x24, 0x75 }, 4, "4c 89 4c 24 XX : mov QWORD PTR [rsp + XX], r9" },
    {  5, { 0x66, 0x48, 0x0F, 0x7E, 0xC0 }, 0, "66 48 0F 7E C0 : movq rax,xmm0 (for wine fexp)" },
    {  5, { 0x83, 0x44, 0x72, 0x73, 0x74 }, 3, "83 44 72 73 74 : add DWORD PTR [rdx+rsi*2+0x73],0x74" },
    {  5, { 0x83, 0x64, 0x24, 0x74, 0x75 }, 3, "83 64 24 XX YY : and DWORD PTR [rsp+XX], YY" },
    {  6, { 0x41, 0xB8, 0x72, 0x73, 0x74, 0x75 }, 0, "41 B8 72 73 74 75 : mov r8d,0x75747372" },
    {  6, { 0x48, 0x83, 0x64, 0x24, 0x75, 0x76 }, 4, "48 83 64 24 XX YY : and QWORD PTR [rsp + XX], YY" },
    {  6, { 0x66, 0x81, 0x78, 0x74, 0x75, 0x76 }, 3, "66 81 78 XX YY YY  cmp WORD PTR [rax+XX], YY YY" },
    {  6, { 0x66, 0x81, 0x79, 0x74, 0x75, 0x76 }, 3, "66 81 79 XX YY YY  cmp WORD PTR [rcx+XX], YY YY" },
    {  6, { 0x66, 0x81, 0x7a, 0x74, 0x75, 0x76 }, 3, "66 81 7a XX YY YY  cmp WORD PTR [rdx+XX], YY YY" },
    {  6, { 0x66, 0x81, 0x7b, 0x74, 0x75, 0x76 }, 3, "66 81 7b XX YY YY  cmp WORD PTR [rbx+XX], YY YY" },
    {  6, { 0x66, 0x81, 0x7e, 0x74, 0x75, 0x76 }, 3, "66 81 7e XX YY YY  cmp WORD PTR [rsi+XX], YY YY" },
    {  6, { 0x66, 0x81, 0x7f, 0x74, 0x75, 0x76 }, 3, "66 81 7f XX YY YY  cmp WORD PTR [rdi+XX], YY YY" },
    ...
    {  6, { 0xF2, 0x0F, 0x11, 0x44, 0x24, 0x75 }, 5, "F2 0f 11 44 24 75 : movsd  QWORD PTR [rsp+0x75],xmm0" },
    {  6, { 0xF2, 0x0F, 0x11, 0x4C, 0x24, 0x75 }, 5, "F2 0f 11 4C 24 75 : movsd  QWORD PTR [rsp+0x75],xmm1" },
    {  6, { 0xF2, 0x0F, 0x11, 0x54, 0x24, 0x75 }, 5, "F2 0f 11 54 24 75 : movsd  QWORD PTR [rsp+0x75],xmm2" },
    {  6, { 0xF2, 0x0F, 0x11, 0x5C, 0x24, 0x75 }, 5, "F2 0f 11 5C 24 75 : movsd  QWORD PTR [rsp+0x75],xmm3" },
    {  6, { 0xF2, 0x0F, 0x11, 0x64, 0x24, 0x75 }, 5, "F2 0f 11 64 24 75 : movsd  QWORD PTR [rsp+0x75],xmm4" },
    ...
    {  7, { 0x81, 0x78, 0x72, 0x73, 0x74, 0x75, 0x76 }, 2, "81 78 72 73 74 75 76 : cmp DWORD PTR [rax+0x72],0x76757473" },
    {  7, { 0x81, 0x79, 0x72, 0x73, 0x74, 0x75, 0x76 }, 2, "81 79 72 73 74 75 76 : cmp DWORD PTR [rcx+0x72],0x76757473" },
    {  7, { 0x81, 0x7A, 0x72, 0x73, 0x74, 0x75, 0x76 }, 2, "81 7A 72 73 74 75 76 : cmp DWORD PTR [rdx+0x72],0x76757473" },
    {  7, { 0x81, 0x7B, 0x72, 0x73, 0x74, 0x75, 0x76 }, 2, "81 7B 72 73 74 75 76 : cmp DWORD PTR [rbx+0x72],0x76757473" },
    {  7, { 0x81, 0x7D, 0x72, 0x73, 0x74, 0x75, 0x76 }, 2, "81 7D 72 73 74 75 76 : cmp DWORD PTR [rbp+0x72],0x76757473" },
    {  7, { 0x81, 0x7E, 0x72, 0x73, 0x74, 0x75, 0x76 }, 2, "81 7E 72 73 74 75 76 : cmp DWORD PTR [rsi+0x72],0x76757473" },
    {  8, { 0x41, 0x81, 0x78, 0x73, 0x74, 0x75, 0x76, 0x77 }, 3, "41 81 78 XX YY YY YY YY : cmp DWORD PTR [r8+YY], XX XX XX XX" },
    {  8, { 0x41, 0x81, 0x79, 0x73, 0x74, 0x75, 0x76, 0x77 }, 3, "41 81 79 XX YY YY YY YY : cmp DWORD PTR [r9+YY], XX XX XX XX" },
    {  8, { 0x41, 0x81, 0x7a, 0x73, 0x74, 0x75, 0x76, 0x77 }, 3, "41 81 7a XX YY YY YY YY : cmp DWORD PTR [r10+YY], XX XX XX XX" },
    {  8, { 0x41, 0x81, 0x7b, 0x73, 0x74, 0x75, 0x76, 0x77 }, 3, "41 81 7b XX YY YY YY YY : cmp DWORD PTR [r11+YY], XX XX XX XX" },
    {  9, { 0x41, 0x81, 0x7c, 0x73, 0x74, 0x75, 0x76, 0x77, 0x78 }, 4, "41 81 7c ZZ XX YY YY YY YY : cmp DWORD PTR [r12+ZZ+YY], XX XX XX XX" },
    {  8, { 0x41, 0x81, 0x7d, 0x73, 0x74, 0x75, 0x76, 0x77 }, 3, "41 81 7d XX YY YY YY YY : cmp DWORD PTR [r13+YY], XX XX XX XX" },
    {  8, { 0x41, 0x81, 0x7e, 0x73, 0x74, 0x75, 0x76, 0x77 }, 3, "41 81 7e XX YY YY YY YY : cmp DWORD PTR [r14+YY], XX XX XX XX" },
    {  8, { 0x41, 0x81, 0x7f, 0x73, 0x74, 0x75, 0x76, 0x77 }, 3, "41 81 7f YY XX XX XX XX : cmp DWORD PTR [r15+YY], XX XX XX XX" },
    {  8, { 0x48, 0x8D, 0xA4, 0x24, 0x74, 0x75, 0x76, 0x77 }, 4, "48 8D A4 24 XX YY ZZ WW : lea rsp, [rsp + WWZZYYXX]" },
    {  8, { 0x81, 0x7c, 0x24, 0x73, 0x74, 0x75, 0x76, 0x77 }, 3, "81 7c 24 YY XX XX XX XX : cmp DWORD PTR [rsp+YY], XX XX XX XX" },
    {  8, { 0xc7, 0x44, 0x24, 0x73, 0x74, 0x75, 0x76, 0x77 }, 3, "C7 44 24 XX YY YY YY YY : mov dword ptr [rsp + XX], YYYYYYYY" },
    {  9, { 0xA1, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x78 }, 0, "A1 71 72 73 74 75 76 77 78 : movabs eax,ds:0x7877767574737271" },
    { 10, { 0x48, 0xb8, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01 }, 0, "48 b8 72 73 74 75 76 77 78 79 : movabs rax,0x7978777675747372" },
    { 11, { 0x66, 0x66, 0x2e, 0x0f, 0x1f, 0x84, 0x77, 0x78, 0x79, 0x7A, 0x7B }, 7, "66 66 2e 0f 1f 84 YY XX XX XX XX : data16 cs nop WORD PTR [rax+rax*1 + XX XX XX XX]" },
    { 13, { 0x66, 0x66, 0x66, 0x66, 0x2e, 0x0f, 0x1f, 0x84, 0x79, 0x7A, 0x7B, 0x7C, 0x7D }, 9, "66 66 66 66 2e 0f 1f 84 YY XX XX XX XX : data16 data16 data16 cs nop WORD PTR [rax+rax*1 + XX XX XX XX]" },
#else //SANITIZER_WINDOWS_x64
    /* sort list */
    //{  3, { 0x8B, 0x45, 0x73 }, 2, "8B 45 XX : mov eax, dword ptr [ebp + XX]" },
    {  3, { 0x8B, 0x5D, 0x73 }, 2, "8B 5D XX : mov ebx, dword ptr [ebp + XX]" },
    {  3, { 0x8B, 0x75, 0x73 }, 2, "8B 75 XX : mov esi, dword ptr [ebp + XX]" },
    {  3, { 0x8B, 0x7D, 0x73 }, 2, "8B 7D XX : mov edi, dword ptr [ebp + XX]" },
    {  3, { 0xFF, 0x75, 0x73 }, 2, "FF 75 XX : push dword ptr [ebp + XX]" },
    {  4, { 0x83, 0x7D, 0x73, 0x74 }, 2, "83 7D XX YY : cmp dword ptr [ebp + XX], YY" },
    {  4, { 0x8A, 0x44, 0x24, 0x74 }, 3, "8A 44 24 XX : mov eal, dword ptr [esp + XX]" },
    {  4, { 0x8B, 0x44, 0x24, 0x74 }, /*3*/0, "8B 44 24 XX : mov eax, dword ptr [esp + XX]" },
    {  4, { 0x8B, 0x4C, 0x24, 0x74 }, 3, "8B 4C 24 XX : mov ecx, dword ptr [esp + XX]" },
    {  4, { 0x8B, 0x54, 0x24, 0x74 }, 3, "8B 54 24 XX : mov edx, dword ptr [esp + XX]" },
    {  4, { 0x8B, 0x5C, 0x24, 0x74 }, 3, "8B 5C 24 XX : mov ebx, dword ptr [esp + XX]" },
    {  4, { 0x8B, 0x6C, 0x24, 0x74 }, 3, "8B 6C 24 XX : mov ebp, dword ptr [esp + XX]" },
    {  4, { 0x8B, 0x74, 0x24, 0x74 }, 3, "8B 74 24 XX : mov esi, dword ptr [esp + XX]" },
    {  4, { 0x8B, 0x7C, 0x24, 0x74 }, 3, "8B 7C 24 XX : mov edi, dword ptr [esp + XX]" },
    {  5, { 0x0F, 0xB6, 0x44, 0x24, 0x75 }, 4, "0F B6 44 24 XX : movzx eax, byte ptr [esp + XX]" },
    ...
    {  7, { 0x83, 0x3D, 0x73, 0x74, 0x75, 0x76, 0x77 }, 2, "83 3D XX YY ZZ WW TT : cmp TT, WWZZYYXX" },
#endif //SANITIZER_WINDOWS_x64


    /* appears in identity test, need to return rel_offset = 0 at i686 */
#if SANITIZER_WINDOWS_x64
    {  3, { 0x8B, 0x45, 0x73 }, 2, "8B 45 73 : MOV eax, dword ptr [ebp+0x73]" },
#else
    {  3, { 0x8B, 0x45, 0x73 }, 0, "8B 45 73 : MOV eax, dword ptr [ebp+0x73]" },
#endif

    /* previously not explicitly mentioned in GetInstructionSize, but need to return 0 to justify tests - are the tests valid? */
    {  0, { 0x00, 0xc3 }, 0, "00 C3 : ADD bl, al" },
    {  0, { 0x25, 0xfe, 0x73, 0x74, 0x75 }, 0, "25 fe XX XX XX : and eax,XXXXXXXX" },
    {  0, { 0xff, 0x00 }, 0, "FF 00 : INC dword ptr [rax]" },
    {  0, { 0x25, 0xf2 }, 0, "25 f2 72 73 74 : AND eax, 0x747372f2" },
    {  0, { 0x0F, 0x0B }, 0, "0F 0B : UD2" },
    {  0, { 0xDB, 0x5E, 0xFF }, 0, "DB 5E FF : FISTP dword ptr [esi-0x1], st0" },
    // clang-format off
};
